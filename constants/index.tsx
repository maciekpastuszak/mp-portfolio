...
export const strengthCards = [
  {
    ...
    description:
      "Thrive on finding creative solutions to complex challenges in order to achieve optimal results",
  },
  {
    src: "/polygon2.svg",
    title: "Innovative",
    description:
      "Constantly exploring new technologies and pushing the boundaries of modern web development",
  },
  {
    src: "/polygon3.svg",
    title: "Continuous learning",
    description:
      "Committed to staying updated with the latest trends and best practices in front-end development.",
  },
  {
    index: 4,
    src: "/polygon4.svg",
    title: "User-focused",
    description:
      "Passionate about creating web experiences that prioritize user needs and preferences.",
  },
];
...
export const portfolioItems = [
  ...
  },
  {
    ...
    title: "Dallee",
    description:
      "A social media platform to create and share DALL-E generated images",
  },
  {
    webUrl:
      "https://expo.dev/@paciekfly/react_native_jobs?serviceType=classic&distribution=expo-go",
